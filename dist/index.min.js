...
function check(str)
	return luacheck.check_strings({str}, {std = std})[1]
end
`});var{LuaFactory:ga}=kt(),ba=xt();(async()=>{let h=new ga,P=await h.createEngine();await P.doString(ba),Object.assign(globalThis,{luacheck:P.global.get("check")})})();})();
